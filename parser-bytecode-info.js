...
const actionFields = {
	NULL_ACTION: [],
	CHECK_ENTITY_NAME: ['JUMP_SPECIAL', 'string', 'entity', 'expected_bool'],
	CHECK_ENTITY_X: ['JUMP_SPECIAL', 'expected_u2', 'entity', 'expected_bool'],
	CHECK_ENTITY_Y: ['JUMP_SPECIAL', 'expected_u2', 'entity', 'expected_bool'],
	CHECK_ENTITY_INTERACT_SCRIPT: ['JUMP_SPECIAL', 'expected_script', 'entity', 'expected_bool'],
	CHECK_ENTITY_TICK_SCRIPT: ['JUMP_SPECIAL', 'expected_script', 'entity', 'expected_bool'],
	CHECK_ENTITY_LOOK_SCRIPT: ['JUMP_SPECIAL', 'expected_script', 'entity', 'expected_bool'],
	CHECK_ENTITY_TYPE: ['JUMP_SPECIAL', 'entity_type', 'entity', 'expected_bool'],
	CHECK_ENTITY_PRIMARY_ID: ['JUMP_SPECIAL', 'expected_u2', 'entity', 'expected_bool'],
	CHECK_ENTITY_SECONDARY_ID: ['JUMP_SPECIAL', 'expected_u2', 'entity', 'expected_bool'],
	CHECK_ENTITY_PRIMARY_ID_TYPE: ['JUMP_SPECIAL', 'entity', 'expected_byte', 'expected_bool'],
	CHECK_ENTITY_CURRENT_ANIMATION: ['JUMP_SPECIAL', 'entity', 'expected_byte', 'expected_bool'],
	CHECK_ENTITY_CURRENT_FRAME: ['JUMP_SPECIAL', 'entity', 'expected_byte', 'expected_bool'],
	CHECK_ENTITY_DIRECTION: ['JUMP_SPECIAL', 'entity', 'direction', 'expected_bool'],
	CHECK_ENTITY_GLITCHED: ['JUMP_SPECIAL', 'entity', 'expected_bool'],
	CHECK_ENTITY_PATH: ['JUMP_SPECIAL', 'geometry', 'entity', 'expected_bool'],
	CHECK_SAVE_FLAG: ['JUMP_SPECIAL', 'save_flag', 'expected_bool'],
	CHECK_IF_ENTITY_IS_IN_GEOMETRY: ['JUMP_SPECIAL', 'geometry', 'entity', 'expected_bool'],
	CHECK_FOR_BUTTON_PRESS: ['JUMP_SPECIAL', 'button_id', 'expected_bool'],
	CHECK_FOR_BUTTON_STATE: ['JUMP_SPECIAL', 'button_id', 'expected_bool'],
	CHECK_WARP_STATE: ['JUMP_SPECIAL', 'string', 'expected_bool'],
	RUN_SCRIPT: ['script'],
	...
	SET_WARP_STATE: [{ propertyName: 'string', size: 2 }],
	...
	CHECK_VARIABLE: ['JUMP_SPECIAL', 'value', 'variable', 'comparison', 'expected_bool'],
	CHECK_VARIABLES: ['JUMP_SPECIAL', 'variable', 'source', 'comparison', 'expected_bool'],
	SLOT_SAVE: [],
	SLOT_LOAD: ['slot'],
	SLOT_ERASE: ['slot'],
	...
	CHECK_MAP: ['JUMP_SPECIAL', 'map', 'expected_bool'],
	SET_BLE_FLAG: ['ble_flag', 'bool_value'],
	CHECK_BLE_FLAG: ['JUMP_SPECIAL', 'ble_flag', 'expected_bool'],
	...
	CHECK_DIALOG_OPEN: ['JUMP_SPECIAL', 'expected_bool'],
	CHECK_SERIAL_DIALOG_OPEN: ['JUMP_SPECIAL', 'expected_bool'],
	CHECK_DEBUG_MODE: ['JUMP_SPECIAL', 'expected_bool'],
	CLOSE_DIALOG: [],
	CLOSE_SERIAL_DIALOG: [],
...
export const isFieldForAction = (field, action) => {
...
export const getBoolFieldForAction = (action) => {
	const fields = actionFields[action];
