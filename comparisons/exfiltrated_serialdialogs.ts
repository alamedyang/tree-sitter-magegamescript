...
export const serialDialogs: Record<string, EncoderSerialDialog> = {
	...
	'ch2-admin.mgs:278:2': {
		messages: [
			"\u001b[33mDEBUG>\u001b[0m: Set flag 'ch2-storyflag-round' to what value? (0-5)",
		],
		text_options: {
	...
	'ch2-admin.mgs:343:2': {
		messages: ["Flag 'ch2-storyflag-round' is now $ch2-storyflag-round$"],
	...
	'ch2-ws-input': {
		...
		text_options: {
			Q: 'ch2-ws-guess-quit',
			QUIT: 'ch2-ws-guess-quit',
			EXIT: 'ch2-ws-guess-quit',
			ALBUM: 'ch2-ws-guess-album',
			ANALOG: 'ch2-ws-guess-analog',
			AUDIO: 'ch2-ws-guess-audio',
			AUX: 'ch2-ws-guess-aux',
			BASS: 'ch2-ws-guess-bass',
			BEAT: 'ch2-ws-guess-beat',
			BPM: 'ch2-ws-guess-bpm',
			BROADCAST: 'ch2-ws-guess-broadcast',
			CASSETTE: 'ch2-ws-guess-cassette',
			CHIPTUNE: 'ch2-ws-guess-chiptune',
			CODEC: 'ch2-ws-guess-codec',
			COMPACT: 'ch2-ws-guess-compact',
			FREQUENCY: 'ch2-ws-guess-frequency',
			HEADPHONES: 'ch2-ws-guess-headphones',
			HIFI: 'ch2-ws-guess-hifi',
			LASER: 'ch2-ws-guess-laser',
			LOFI: 'ch2-ws-guess-lofi',
			MEDIA: 'ch2-ws-guess-media',
			MICROPHONE: 'ch2-ws-guess-microphone',
			MIDI: 'ch2-ws-guess-midi',
			MIXING: 'ch2-ws-guess-mixing',
			MUSIC: 'ch2-ws-guess-music',
			PHONOGRAPH: 'ch2-ws-guess-phonograph',
			RADIO: 'ch2-ws-guess-radio',
			RECORDING: 'ch2-ws-guess-recording',
			RHYTHM: 'ch2-ws-guess-rhythm',
			SEQUENCER: 'ch2-ws-guess-sequencer',
			SONG: 'ch2-ws-guess-song',
			SOUNDTRACK: 'ch2-ws-guess-soundtrack',
			SPEAKERS: 'ch2-ws-guess-speakers',
			STEREO: 'ch2-ws-guess-stereo',
			STREAM: 'ch2-ws-guess-stream',
			SUBWOOFER: 'ch2-ws-guess-subwoofer',
			SURROUND: 'ch2-ws-guess-surround',
			SYNTHESIZER: 'ch2-ws-guess-synthesizer',
			TAPE: 'ch2-ws-guess-tape',
			TREBLE: 'ch2-ws-guess-treble',
			VINYL: 'ch2-ws-guess-vinyl',
			VOCODER: 'ch2-ws-guess-vocoder',
			VOLUME: 'ch2-ws-guess-volume',
			ALBUMS: 'ch2-ws-guess-albums',
			BASE: 'ch2-ws-guess-base',
			BEATS: 'ch2-ws-guess-beats',
			BROADCASTS: 'ch2-ws-guess-broadcasts',
			CASSETTES: 'ch2-ws-guess-cassettes',
			CHIPTUNES: 'ch2-ws-guess-chiptunes',
			CODECS: 'ch2-ws-guess-codecs',
			FREQUENCIES: 'ch2-ws-guess-frequencies',
			GRAMOPHONE: 'ch2-ws-guess-gramophone',
			HEADPHONE: 'ch2-ws-guess-headphone',
			LASERS: 'ch2-ws-guess-lasers',
			MICROPHONES: 'ch2-ws-guess-microphones',
			PHONES: 'ch2-ws-guess-phones',
			PHONE: 'ch2-ws-guess-phone',
			MIC: 'ch2-ws-guess-mic',
			MUSICIAN: 'ch2-ws-guess-musician',
			RADIOS: 'ch2-ws-guess-radios',
			RECORDINGS: 'ch2-ws-guess-recordings',
			RECORD: 'ch2-ws-guess-record',
			SEQUENCE: 'ch2-ws-guess-sequence',
			SEQUENCERS: 'ch2-ws-guess-sequencers',
			SING: 'ch2-ws-guess-sing',
			SINGING: 'ch2-ws-guess-singing',
			SONGS: 'ch2-ws-guess-songs',
			SOUND: 'ch2-ws-guess-sound',
			SOUNDTRACKS: 'ch2-ws-guess-soundtracks',
			SYNTH: 'ch2-ws-guess-synth',
			SYNTHESIZERS: 'ch2-ws-guess-synthesizers',
			TRACK: 'ch2-ws-guess-track',
			TRACKS: 'ch2-ws-guess-tracks',
			SPEAKER: 'ch2-ws-guess-speaker',
			STEREOS: 'ch2-ws-guess-stereos',
			STREAMS: 'ch2-ws-guess-streams',
			SUBWOOFERS: 'ch2-ws-guess-subwoofers',
			TAPES: 'ch2-ws-guess-tapes',
			TUNE: 'ch2-ws-guess-tune',
			TUNES: 'ch2-ws-guess-tunes',
			VINYLS: 'ch2-ws-guess-vinyls',
			VOCODERS: 'ch2-ws-guess-vocoders',
			'GLITTERING PRIZES': 'ch2-ws-guess-cheat',
		},
		name: 'ch2-ws-input',
	},
	...
	'ch2-castle-12.mgs:340:2': {
		messages: [
			...
			'         Type a word! (or type Q to quit)            \u001b[33mPts to win: $ch2-ws-flags-tally$/20\u001b[0m',
		],
	...
	'ch2-castle-12.mgs:425:2': {
		...
		options: [
			{
				label: 'Hello.',
				script: 'ch2-stereo-intro2a',
			},
			{
				label: 'Howdy.',
				script: 'ch2-stereo-intro2b',
			},
			{
				label: 'Ahoy.',
				script: 'ch2-stereo-intro2c',
			},
		],
	...
	'ch2-castle-14.mgs:301:2': {
		...
		text_options: {
			AUTHENTICATE: 'interact-ch2-keypad-good-pass',
		},
